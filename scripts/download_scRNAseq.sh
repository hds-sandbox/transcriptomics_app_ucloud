...
curl "https://zenodo.org/record/7835764/files/Data.zip?download=1" -o /work/Intro_to_scRNAseq_R/Data.zip
...
## Data download
# download Data.zip to Data from zenodo and unzip
curl "https://zenodo.org/record/7835764/files/Notebooks.zip?download=1" -o /work/Intro_to_scRNAseq_R/Notebooks.zip
